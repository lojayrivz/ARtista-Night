...
public class RasPiScript : MonoBehaviour {


	public InputField iF;
	public Transform Success,Fail,BlackFade,RasPi,BlackFadeQ,Badge2,ID;
	bool click;
	...
	public void GetInput(){
		...
		iF.text = "";
		if (input == "Raspberry Pi" || input == "raspberry pi" || input == "Raspberry pi") {
			RasPi.gameObject.SetActive (false);
