...
public class RiddleQ1Script : MonoBehaviour {

	public InputField iF;
	public Transform Success,Fail,BlackFade,RQ1,BlackFadeQ,Badge5;
	bool click;
	...
	public void GetInput(){
		...
		iF.text = "";
		if (input == "keyboard" || input == "Keyboard") {
			RQ1.gameObject.SetActive (false);
