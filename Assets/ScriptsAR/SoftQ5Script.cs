...
public class SoftQ5Script : MonoBehaviour {
	public InputField iF;
	public Transform Success,Fail,BlackFade,SQ5,BlackFadeQ,Badge6;
	bool click;
	...
	public void GetInput(){
		...
		iF.text = "";
		if (input == "MatLab" || input == "MATLAB") {
			SQ5.gameObject.SetActive (false);
